...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description="Run cross-domain validation for an XGBoost landmark model."
    )
    parser.add_argument(
        "--model-path",
        default="models/blender_xgboost.pkl",
        help="Path to XGBoost model file (.pkl/.joblib).",
    )
    parser.add_argument(
        "--source-dataset",
        default="blender",
    ...
    parser.add_argument(
        "--output-dir",
        default="models/stats/cross_domain/blender_xgboost",
        help="Output directory for detailed rows and summary CSV.",
    )
    parser.add_argument(
        "--tag",
        default="blender_xgboost",
