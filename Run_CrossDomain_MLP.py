...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description="Run cross-domain validation for an MLP landmark model."
    )
    parser.add_argument(
        "--model-path",
        default="models/blender_MLP.pth",
        help="Path to MLP checkpoint (.pth).",
    )
    parser.add_argument(
        "--source-dataset",
        default="blender",
    ...
    parser.add_argument(
        "--output-dir",
        default="models/stats/cross_domain/blender_mlp",
